...
public final class ApiRoutes {
    ...
    public static final String FOOD_PATH_BY_ID = FOOD_PATH + "/{id}";
    public static final String FOOD_TYPE_PATH = BASE_PATH + "/food-type";
    public static final String FOOD_TYPE_PATH_BY_ID = FOOD_TYPE_PATH + "/{id}";
    ...
    public static final String FOOD_CONSUMPTION_PATH_BY_ID = FOOD_CONSUMPTION_PATH + "/{id}";
